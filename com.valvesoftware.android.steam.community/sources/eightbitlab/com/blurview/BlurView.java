...
public class BlurView extends FrameLayout {
    ...
    private void init(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2691R.styleable.BlurView, i, 0);
        this.overlayColor = obtainStyledAttributes.getColor(C2691R.styleable.BlurView_blurOverlayColor, 0);
