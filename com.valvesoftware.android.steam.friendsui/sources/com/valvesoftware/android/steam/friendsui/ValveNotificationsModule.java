...
import com.valvesoftware.android.steam.friendsui.ValveNotificationsHelper;
...
public class ValveNotificationsModule extends ReactContextBaseJavaModule {
    ...
    public ValveNotificationsModule(final ReactApplicationContext reactApplicationContext) {
        ...
        ValveNotificationsHelper.getInstance().registerMessageReceivedListener(new ValveNotificationsHelper.OnMessageReceivedListener() { // from class: com.valvesoftware.android.steam.friendsui.ValveNotificationsModule.1
            @Override // com.valvesoftware.android.steam.friendsui.ValveNotificationsHelper.OnMessageReceivedListener
    ...
    public void getFcmDeviceToken(final Promise promise) {
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() { // from class: com.valvesoftware.android.steam.friendsui.ValveNotificationsModule.2
